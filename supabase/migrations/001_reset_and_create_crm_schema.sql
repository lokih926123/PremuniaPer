-- ========================================
-- MIGRATION: Reset et création du schéma CRM moderne
-- ========================================
-- IMPORTANT: Cette migration réinitialise la base complètement
-- Sauvegardez vos données avant d'exécuter!

-- ========================================
-- PHASE 1: SUPPRESSION DES TABLES EXISTANTES (en ordre inverse des dépendances)
-- ========================================
...
-- Référence aux automations dans lead_interactions
ALTER TABLE public.lead_interactions
ADD CONSTRAINT lead_interactions_automation_fkey 
